; jupiter runtime header for version 0.0.9
...
declare i32 @ju_to_int (i8*)                    ; int  to_int (juc cell)
declare i1  @ju_to_bool (i8*)                   ; bool to_bool (juc cell)
declare i8* @ju_from_int (i32)                  ; juc  from_int (int n)
declare i8* @ju_from_bool (i1)                  ; juc  from_bool (bool b)
declare i1  @ju_is_int (i8*)                    ; bool is_int (juc cell)
